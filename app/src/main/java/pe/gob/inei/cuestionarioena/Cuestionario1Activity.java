...
import pe.gob.inei.cuestionarioena.fragments.C1P3Fragment;
...
public class Cuestionario1Activity extends AppCompatActivity {
    ...
    private C1P3Fragment c1P3Fragment;
            ...
            public void onClick(View view) {
                switch (fragmentActual){
                    ...
                    case 1:
                        fragmentManager = getSupportFragmentManager();
                        fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.container,c1P3Fragment);
                        fragmentTransaction.commit();
                        fragmentActual++;
